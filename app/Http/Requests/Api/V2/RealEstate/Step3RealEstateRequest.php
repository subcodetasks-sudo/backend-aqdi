...
class Step3RealEstateRequest extends BaseApiV2Request
{
    ...
    public function rules(): array
    {
        return [
            ...
            'agency_instrument_date_of_property_owner_day' => 'nullable|required_if:add_legal_agent_of_owner,1|integer|between:1,31',
            'agency_instrument_date_of_property_owner_month' => 'nullable|required_if:add_legal_agent_of_owner,1|integer|between:1,12',
            'agency_instrument_date_of_property_owner_year' => 'nullable|required_if:add_legal_agent_of_owner,1|integer|min:1900|max:2100',
    ...
    public function messages(): array
    {
        return [
            ...
            'agency_instrument_date_of_property_owner_day.required_if' => 'يوم تاريخ صك الوكالة مطلوب.',

    ...
    private function buildStepBasedDetailResponse(array $detail): array
    {
        return [
            'contract_summary' => array_merge(Arr::only($detail, [
                ...
                'instrument_type_trans' => Arr::get($detail, 'instrument_type_trans'),
                'instrument_type_label' => Arr::get($detail, 'instrument_type_label', Arr::get($detail, 'instrument_type_trans')),
                'contract_type_key' => Arr::get($detail, 'contract_type_key', Arr::get($detail, 'contract_type')),
                'instrument_type_key' => Arr::get($detail, 'instrument_type_key'),

...
$folders = [
    ...
    'Message alerts — sections' => [
        ...
        req('Show', 'GET', '/message-alert-sections/{{id}}'),
        req('Update', 'POST', '/message-alert-sections/{{id}}', ['body' => ['name_ar' => '']]),
        req('Delete', 'POST', '/message-alert-sections/{{id}}/delete'),
    ],
    'Message alerts — section items' => [
        req('Options list (dropdown)', 'GET', '/message-alert-section-items/options/list', ['query' => ['message_alert_section_id' => '1', 'type' => 'client']]),
        req('List', 'GET', '/message-alert-section-items', ['query' => ['type' => 'client']]),
        req('Create', 'POST', '/message-alert-section-items', ['body' => ['message_alert_section_id' => 1, 'name_ar' => '', 'sort_order' => 0]]),
        req('Show', 'GET', '/message-alert-section-items/{{id}}'),
        req('Update', 'POST', '/message-alert-section-items/{{id}}', ['body' => []]),
        req('Delete', 'POST', '/message-alert-section-items/{{id}}/delete'),
    ],
    'Message alerts' => [
        req('List', 'GET', '/message-alerts', ['query' => ['type' => 'client']]),
        req('Create', 'POST', '/message-alerts', ['body' => ['type' => 'client', 'message_alert_section_item_id' => 1, 'message' => '']]),

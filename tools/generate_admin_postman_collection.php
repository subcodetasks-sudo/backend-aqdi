...
$folders = [
    ...
    'Orders' => [
        ...
        req('List orders — is_received true', 'GET', '/orders', ['query' => ['is_received' => '1']]),
        req('List orders — is_received false', 'GET', '/orders', ['query' => ['is_received' => '0']]),
        req('List orders — received only (legacy param)', 'GET', '/orders', ['query' => ['received_contract' => '1']]),
        req('List orders — not received only (legacy param)', 'GET', '/orders', ['query' => ['received_contract' => '0']]),
        req('Incomplete orders', 'GET', '/orders/incomplete/list'),
        req('Incomplete orders — is_received true', 'GET', '/orders/incomplete/list', ['query' => ['is_received' => '1']]),
        req('Incomplete orders — is_received false', 'GET', '/orders/incomplete/list', ['query' => ['is_received' => '0']]),
        req('Complete orders', 'GET', '/orders/complete/list'),
        req('Complete orders — is_received true', 'GET', '/orders/complete/list', ['query' => ['is_received' => '1']]),
        req('Complete orders — is_received false', 'GET', '/orders/complete/list', ['query' => ['is_received' => '0']]),

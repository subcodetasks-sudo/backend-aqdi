!(function (e, t) {
  ...
  function w(e) {
    var t = null;
    if (!k[e] && "undefined" != typeof module && module && module.exports)
      try {
  ...
  function v(e, t) {
    return null !== t
      ? ((t.abbr = e), (k[e] = k[e] || new y()), k[e].set(t), T(e), k[e])
      : (delete k[e], null);
  }
  function b(e) {
    var t;
    ...
    return (function (e) {
      for (var t, a, n, s, r = 0; r < e.length; ) {
        for (
          t = (s = g(e[r]).split("-")).length,
            a = (a = g(e[r + 1])) ? a.split("-") : null;
          t > 0;
  ...
  function P(e, a) {
    return function (n) {
      return null != n
        ? (A(this, e, n), t.updateOffset(this, a), this)
        : F(this, e);
    };
  }
  function F(e, t) {
        ...
        (J[t] =
          ...
          (function (e) {
            ...
            return function (n) {
              var r = "";
              for (t = 0; t < a; t++)
                r += s[t] instanceof Function ? s[t].call(n, e) : s[t];
              return r;
            };
          })(t)),
        J[t](e))
  ...
  function He(e) {
    return null != e
      ? (Se(this, e), t.updateOffset(this, !0), this)
      : F(this, "Month");
  }
  var je = ie;
  var xe = ie;
  function We() {
    ...
    for (n.sort(e), s.sort(e), r.sort(e), t = 0; t < 12; t++)
      (n[t] = ue(n[t])), (s[t] = ue(s[t])), (r[t] = ue(r[t]));
    ...
    return (
      a &&
        ...
        ((t =
          a[pe] < 0 || a[pe] > 11
            ? pe
            : a[fe] < 1 || a[fe] > we(a[Me], a[pe])
            ? fe
            : a[Ye] < 0 ||
              a[Ye] > 24 ||
              (24 === a[Ye] && (0 !== a[Le] || 0 !== a[ye] || 0 !== a[De]))
            ? Ye
            : a[Le] < 0 || a[Le] > 59
            ? Le
            : a[ye] < 0 || a[ye] > 59
            ...
            ? De
            : -1),
        o(e)._overflowDayOfYear && (t < Me || t > fe) && (t = fe),
        o(e)._overflowWeeks && -1 === t && (t = ke),
        o(e)._overflowWeekday && -1 === t && (t = ge),
        (o(e).overflow = t)),
      e
    );
  }
  ...
  function $e(e, t, a) {
    ...
    return (
      i < 1
        ? (n = i + Ke((s = e.year() - 1), t, a))
        : i > Ke(e.year(), t, a)
        ? ((n = i - Ke(e.year(), t, a)), (s = e.year() + 1))
        : ((s = e.year()), (n = i)),
      { week: n, year: s }
    );
  }
    ...
    if (!e._d) {
      for (
        s = (function (e) {
          ...
          e._w &&
            ...
            (function (e) {
              ...
              null != (t = e._w).GG || null != t.W || null != t.E
                ? ((r = 1),
                  (i = 4),
                  (a = Qe(t.GG, e._a[Me], $e(nt(), 1, 4).year)),
                  (n = Qe(t.W, 1)),
                  ((s = Qe(t.E, 1)) < 1 || s > 7) && (_ = !0))
                : ((r = e._locale._week.dow),
                  (i = e._locale._week.doy),
                  (a = Qe(t.gg, e._a[Me], $e(nt(), r, i).year)),
                  (n = Qe(t.w, 1)),
                  null != t.d
                    ? ((s = t.d) < 0 || s > 6) && (_ = !0)
                    : null != t.e
                    ...
                    : (s = r));
              n < 1 || n > Ke(a, r, i)
                ? (o(e)._overflowWeeks = !0)
                : null != _
                ? (o(e)._overflowWeekday = !0)
                : ((d = Be(a, n, s, r, i)),
                  (e._a[Me] = d.year),
          ...
          e._dayOfYear &&
            ((r = Qe(e._a[Me], s[Me])),
            e._dayOfYear > Ue(r) && (o(e)._overflowDayOfYear = !0),
  ...
  function et(e) {
    if (e._f !== t.ISO_8601) {
      ...
      var a,
        ...
        _ = d.length,
        u = 0;
      for (s = V(e._f, e._locale).match(E) || [], a = 0; a < s.length; a++)
        (r = s[a]),
          (n = (d.match(_e(r, e)) || [])[0]) &&
            ((i = d.substr(0, d.indexOf(n))).length > 0 &&
              o(e).unusedInput.push(i),
            (d = d.slice(d.indexOf(n) + n.length)),
            (u += n.length)),
          I[r]
            ? (n ? (o(e).empty = !1) : o(e).unusedTokens.push(r), ce(r, n, e))
            : e._strict && !n && o(e).unusedTokens.push(r);
      (o(e).charsLeftOver = _ - u),
        d.length > 0 && o(e).unusedInput.push(d),
        !0 === o(e).bigHour &&
          e._a[Ye] <= 12 &&
          e._a[Ye] > 0 &&
          (o(e).bigHour = void 0),
          ...
          p(r)
            ...
            : (a(d)
                ? (function (e) {
                    ...
                    if (0 === e._f.length)
                      return (
                        (o(e).invalidFormat = !0), void (e._d = new Date(NaN))
                      );
  ...
  function at(e, t, a, n, s) {
    ...
    return (
      ...
      (i._f = t),
      (i._strict = n),
      (r = new M(Pe(tt(i))))._nextDay && (r.add(1, "d"), (r._nextDay = void 0)),
      r
    );
  }
  function nt(e, t, a, n) {
  ...
  function dt(e) {
    var t = x(e),
      ...
      _ = t.second || 0,
      u = t.millisecond || 0;
    (this._milliseconds = +u + 1e3 * _ + 6e4 * o + 36e5 * d),
      (this._days = +i + 7 * r),
        ...
        : "object" == typeof i &&
          ...
          ((s = (function (e, t) {
            ...
            (t = lt(t, e)),
              e.isBefore(t)
                ? (a = Lt(e, t))
                : (((a = Lt(t, e)).milliseconds = -a.milliseconds),
                  (a.months = -a.months));
            return a;
          })(nt(i.from), nt(i.to))),
          ((i = {}).ms = s.milliseconds),
          (i.M = s.months)),
      (n = new dt(i)),
      ot(e) && r(e, "_locale") && (n._locale = e._locale),
      n
    );
  }
  function Yt(e, t) {
    ...
    return function (a, n) {
      ...
      return (
        null === n ||
          ...
          (a = n),
          (n = s)),
        Dt(this, ft((a = "string" == typeof a ? +a : a), n), e),
        this
      );
    };
  }
  function Dt(e, a, n, s) {
    ...
    e.isValid() &&
      ...
      i && A(e, "Date", F(e, "Date") + i * n),
      d && Se(e, F(e, "Month") + d * n),
  ...
  function wt(e) {
    ...
    return void 0 === e
      ? this._locale._abbr
      : (null != (t = b(e)) && (this._locale = t), this);
  }
  ...
  N(0, ["gg", 2], 0, function () {
    ...
    oe("GGGGG", te, B),
    oe("ggggg", te, B),
    he(["gggg", "ggggg", "GGGG", "GGGGG"], function (e, t, a, n) {
      t[n.substr(0, 2)] = Y(e);
    }),
  ...
  (Nt.add = kt),
    ...
    (Nt.diff = function (e, t, a) {
      var n, s, r, i;
      return this.isValid() && (n = lt(e, this)).isValid()
        ? ((s = 6e4 * (n.utcOffset() - this.utcOffset())),
          "year" === (t = j(t)) || "month" === t || "quarter" === t
            ? ((d = this),
              (o = n),
              (m = 12 * (o.year() - d.year()) + (o.month() - d.month())),
              (l = d.clone().add(m, "months")),
              o - l < 0
                ? ((_ = d.clone().add(m - 1, "months")),
                  (u = (o - l) / (l - _)))
                : ((_ = d.clone().add(m + 1, "months")),
                  (u = (o - l) / (_ - l))),
              (i = -(m + u)),
    ...
    (Nt.from = function (e, t) {
      return this.isValid() && ((p(e) && e.isValid()) || nt(e).isValid())
    ...
    (Nt.isAfter = function (e, t) {
      ...
      return (
        ...
        ("millisecond" === (t = j(m(t) ? "millisecond" : t))
          ? +this > +a
    ...
    (Nt.max = rt),
    (Nt.min = st),
    (Nt.parsingFlags = function () {
      return i({}, o(this));
    }),
    (Nt.set = C),
    (Nt.startOf = function (e) {
      switch ((e = j(e))) {
        case "year":
          this.month(0);
        case "quarter":
    ...
    (Nt.hour = Nt.hours = Ct),
    (Nt.minute = Nt.minutes = Ot),
    (Nt.second = Nt.seconds = zt),
    (Nt.millisecond = Nt.milliseconds = It),
    (Nt.utcOffset = function (e, a) {
      var n,
        s = this._offset || 0;
      return this.isValid()
        ? null != e
          ? ("string" == typeof e
              ? (e = mt(re, e))
              : Math.abs(e) < 16 && (e *= 60),
            !this._isUTC && a && (n = ht(this)),
            (this._offset = e),
            (this._isUTC = !0),
            null != n && this.add(n, "m"),
            s !== e &&
              (!a || this._changeInProgress
                ? Dt(this, ft(e - s, "m"), 1, !1)
    ...
    (Nt.parseZone = function () {
      return (
        this._tzm
          ...
          : "string" == typeof this._i && this.utcOffset(mt(se, this._i)),
        this
      );
    }),
    ...
    (Nt.isUtc = ct),
    (Nt.isUTC = ct),
    (Nt.zoneAbbr = function () {
      return this._isUTC ? "UTC" : "";
    }),
    (Nt.zoneName = function () {
      return this._isUTC ? "Coordinated Universal Time" : "";
    }),
    (Nt.dates = Ae("dates accessor is deprecated. Use date instead.", Ht)),
    (Nt.months = Ae("months accessor is deprecated. Use month instead", He)),
    (Nt.years = Ae("years accessor is deprecated. Use year instead", Re)),
    (Nt.zone = Ae(
  ...
  (Ut._calendar = {
    ...
    (Ut._invalidDate = "Invalid date"),
    (Ut.invalidDate = function () {
      return this._invalidDate;
    }),
    (Ut._ordinal = "%d"),
    (Ut.ordinal = function (e) {
      return this._ordinal.replace("%d", e);
    }),
    (Ut._ordinalParse = /\d{1,2}/),
    (Ut.preparse = Vt),
    (Ut.postformat = Vt),
    (Ut._relativeTime = {
      future: "in %s",
    ...
    (Ut.months = function (e, t) {
      return a(this._months)
        ...
        : this._months[Te.test(t) ? "format" : "standalone"][e.month()];
    }),
    (Ut._months = ve),
    (Ut.monthsShort = function (e, t) {
      return a(this._monthsShort)
        ? this._monthsShort[e.month()]
        : this._monthsShort[Te.test(t) ? "format" : "standalone"][e.month()];
    }),
    (Ut._monthsShort = be),
    (Ut.monthsParse = function (e, t, a) {
      var n, s, r;
      for (
        this._monthsParse ||
          ((this._monthsParse = []),
    ...
    (Ut._monthsRegex = xe),
    (Ut.monthsRegex = function (e) {
      return this._monthsParseExact
        ? (r(this, "_monthsRegex") || We.call(this),
          e ? this._monthsStrictRegex : this._monthsRegex)
        : this._monthsStrictRegex && e
        ? this._monthsStrictRegex
        : this._monthsRegex;
    }),
    (Ut._monthsShortRegex = je),
    (Ut.monthsShortRegex = function (e) {
      return this._monthsParseExact
        ? (r(this, "_monthsRegex") || We.call(this),
    ...
    (Ut._weekdays = jt),
    (Ut.weekdaysMin = function (e) {
      return this._weekdaysMin[e.day()];
    }),
    (Ut._weekdaysMin = Wt),
    (Ut.weekdaysShort = function (e) {
      return this._weekdaysShort[e.day()];
    }),
    (Ut._weekdaysShort = xt),
    (Ut.weekdaysParse = function (e, t, a) {
      var n, s, r;
      for (
        this._weekdaysParse ||
          ((this._weekdaysParse = []),
    ...
    (Ut._meridiemParse = /[ap]\.?m?\.?/i),
    (Ut.meridiem = function (e, t, a) {
    ...
    (t.lang = Ae("moment.lang is deprecated. Use moment.locale instead.", T)),
    (t.langData = Ae(
  ...
  var en = "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split(
      "_"
    ),
  ...
  function un(e, t, a, n) {
    ...
    switch (a) {
      ...
      case "mm":
        return _n(e)
          ? s + (t || n ? "mínútur" : "mínútum")
          : t
          ? s + "mínúta"
          : s + "mínútu";
      case "hh":
        return _n(e)
          ? s + (t || n ? "klukkustundir" : "klukkustundum")
          : s + "klukkustund";
      case "d":
  ...
  function Yn(e, t, a, n) {
    ...
    return 1 === e
      ? s + Mn(0, t, a[0], n)
      : t
      ? s + (pn(e) ? fn(a)[1] : fn(a)[0])
      : n
      ? s + fn(a)[1]
      : s + (pn(e) ? fn(a)[1] : fn(a)[2]);
  }
  Da.defineLocale("lt", {
    months: {
      format:
      ...
      translate: function (e, t, a) {
        ...
        return 1 === a.length
          ? t
            ? n[0]
            : n[1]
          : e + " " + gn.correctGrammaticalCase(e, n);
      },
    },
    wn =
      (Da.defineLocale("me", {
  ...
  function On(e, t, a) {
    ...
    return (
      ...
      e + n + { mm: "minute", hh: "ore", dd: "zile", MM: "luni", yy: "ani" }[a]
    );
  }
  Da.defineLocale("ro", {
    months:
      ...
      translate: function (e, t, a) {
        ...
        return 1 === a.length
          ? t
            ? n[0]
            : n[1]
          : e + " " + Un.correctGrammaticalCase(e, n);
      },
    },
    qn =
      (Da.defineLocale("sr-cyrl", {
        months: [
          "јануар",
          "фебруар",
          "март",
        ...
        translate: function (e, t, a) {
          ...
          return 1 === a.length
            ? t
              ? n[0]
              : n[1]
            : e + " " + qn.correctGrammaticalCase(e, n);
        },
      }),
    Rn =
      (Da.defineLocale("sr", {
  ...
  (function (e, t) {
    ...
    var t,
      ...
      n = {
        ummalquraData: [
          ...
          67882, 67911, 67941, 67971, 68e3, 68030, 68060, 68089, 68119, 68148,
      ...
      k(
          ...
          : a.constructor.prototype),
        {
          ...
          iMonthsParse: function (e) {
            var t, a, n;
            for (
              this._iMonthsParse || (this._iMonthsParse = []), t = 0;
              t < 12;
              t += 1
            )
              if (
                (this._iMonthsParse[t] ||
                  ((a = F([2e3, (2 + t) % 12, 25])),
                  (n =
                    "^" +
                    this.iMonths(a, "") +
                    ...
                    this.iMonthsShort(a, "") +
                    "$"),
                  (this._iMonthsParse[t] = new RegExp(
                    n.replace(".", ""),
                    "i"
                  ))),
                this._iMonthsParse[t].test(e))
              )
                return t;
          },
        }
    ...
    function j(t, a, n) {
      ...
      switch (t) {
        ...
        case "iMMM":
        case "iMMMM":
          null != (s = e.localeData(n._l).iMonthsParse(a))
            ? (r[1] = s)
            : (n._isValid = !1);
          break;
        case "iD":
      ...
      return (
        ...
        (function (e) {
          var t,
            ...
            s = e._a[1],
            r = e._a[2];
          return null == n && null == s && null == r
            ? [0, 0, 1]
            : ((n = n || 0),
              (s = s || 0),
              ((r = r || 1) < 1 || r > F.iDaysInMonth(n, s)) &&
                (e._isValid = !1),
              (a = A((t = C(n, s, r)).gy, t.gm, t.gd)),
              (e._hDiff = 0),
              ~~a.hy !== n && (e._hDiff += 1),
              ~~a.hm !== s && (e._hDiff += 1),
              ~~a.hd !== r && (e._hDiff += 1),
    ...
    function W(e, t, a) {
      ...
      return (
        ...
        r < s - 7 && (r += 7),
        (n = F(e).add(r, "d")),
        { week: Math.ceil(n.iDayOfYear() / 7), year: n.iYear() }
      );
    }
    function P(t, a, n, r) {
      var i,
        ...
        (i = x(_)),
          (function (e) {
            var t,
              ...
              _ = o.length;
            for (t = 0; t < _; t += 1)
              (n = (H((a = o[t]), e).exec(r) || [])[0]) &&
                (r = r.slice(r.indexOf(n) + n.length)),
                L[a] instanceof Function || ((d += a), n && (i += n));
            (e._i = i), (e._f = d);
          })(_),
          (a = "YYYY-MM-DD-" + _._f),
          (t =
            g(i[0], 4) + "-" + g(i[1] + 1, 2) + "-" + g(i[2], 2) + "-" + _._i);
      }
      return (
        (d = r ? e.utc(t, a, n) : e(t, a, n)),
        !1 === _._isValid && (d._isValid = !1),
        (d._hDiff = _._hDiff || 0),
        k((o = v(F.fn)), d),
        o
      );
    ...
    function C(e, t, a) {
      var s,
        ...
        _ =
          ...
          (r =
            (r = 4 * s + 139361631) +
            4 * O(3 * O(4 * s + 183187720, 146097), 4) -
            3908),
          (i = 5 * O(E(r, 1461), 4) + 308),
          (d = O(E(i, 153), 5) + 1),
          (o = E(O(i, 153), 12) + 1),
          { gy: O(r, 1461) - 100100 + O(8 - o, 6), gm: o, gd: d });
      return (_.gm -= 1), _;
    }
    return (
      k(F, e),
      (F.fn = v(e.fn)),
      (F.utc = function (e, t, a) {
        return P(e, t, a, !0);
      }),
      ...
      (F.fn.iYear = function (t) {
        ...
        return "number" == typeof t
          ? ((n = A(this.year(), this.month(), this.date())),
            (a = Math.min(n.hd, F.iDaysInMonth(t, n.hm))),
            T(this, (s = C(t, n.hm, a)).gy, s.gm, s.gd),
            (this.month() === s.gm &&
              this.date() === s.gd &&
              this.year() === s.gy) ||
              T(this, s.gy, s.gm, s.gd),
            e.updateOffset(this),
            this)
          : A(this.year(), this.month(), this.date()).hy;
      }),
      (F.fn.iMonth = function (t) {
        ...
        if (null != t) {
          ...
          return (
            (n = A(this.year(), this.month(), this.date())),
            (a = Math.min(n.hd, F.iDaysInMonth(n.hy, t))),
            this.iYear(n.hy + O(t, 12)),
            (t = E(t, 12)) < 0 && ((t += 12), this.iYear(this.iYear() - 1)),
            T(this, (s = C(this.iYear(), t, a)).gy, s.gm, s.gd),
            (this.month() === s.gm &&
              this.date() === s.gd &&
              this.year() === s.gy) ||
              T(this, s.gy, s.gm, s.gd),
      ...
      (F.fn.iDate = function (t) {
        ...
        return "number" == typeof t
          ? (T(
              this,
              (n = C(
                (a = A(this.year(), this.month(), this.date())).hy,
                a.hm,
                t
              )).gy,
              n.gm,
            ...
            (this.month() === n.gm &&
              this.date() === n.gd &&
              this.year() === n.gy) ||
              T(this, n.gy, n.gm, n.gd),
            e.updateOffset(this),
            this)
          : A(this.year(), this.month(), this.date()).hd;
      }),
      (F.fn.iDayOfYear = function (e) {
        var t =
          Math.round(
            (F(this).startOf("day") - F(this).startOf("iYear")) / 864e5
          ) + 1;
        return null == e ? t : this.add(e - t, "d");
      }),
      ...
      (F.fn.add = function (t, a) {
        var n;
        return (
          null === a || isNaN(+a) || ((n = t), (t = a), (a = n)),
          "iyear" === (a = w(a))
            ? this.iYear(this.iYear() + t)
            : "imonth" === a
            ? this.iMonth(this.iMonth() + t)
            : "idate" === a
            ? this.iDate(this.iDate() + t)
            : e.fn.add.call(this, t, a),
          this
        );
      }),
      (F.fn.subtract = function (t, a) {
        ...
        return (
          ...
          "iyear" === (a = w(a))
            ...
            : "idate" === a
            ? this.iDate(this.iDate() - t)
            : e.fn.subtract.call(this, t, a),
          this
        );
      }),
      (F.fn.startOf = function (t) {
        return "iyear" === (t = w(t)) || "imonth" === t
          ? ("iyear" === t && this.iMonth(0),
            this.iDate(1),
            this.hours(0),
            this.minutes(0),
            this.seconds(0),
            this.milliseconds(0),
            this)
          : e.fn.startOf.call(this, t);
      }),
      (F.fn.endOf = function (e) {
        return void 0 === (e = w(e)) || "milisecond" === e
          ? this
          : this.startOf(e)
              .add(1, "isoweek" === e ? "week" : e)
      ...
      (F.fn.iYears = F.fn.iYear),
      (F.fn.iMonths = F.fn.iMonth),
      (F.fn.iDates = F.fn.iDate),
      (F.fn.iWeeks = F.fn.iWeek),
      (F.iDaysInMonth = function (e, t) {
        var a = z(e, t + 1);
        return n.ummalquraData[a] - n.ummalquraData[a - 1];
      }),
      (F.iConvert = { toHijri: A, toGregorian: C }),
      F
    );
    function O(e, t) {
      return ~~(e / t);
  ...
  (function (e) {
    ...
    if (!t)
      throw new Error(
        "bootstrap-hijri-datepicker requires Moment.js to be loaded first"
      );
    var a = function (a, n) {
      var s,
        r,
        ...
        f = 0,
        Y = [
          { clsName: "days", navFnc: n.hijri ? "iMonth" : "Month", navStep: 1 },
          { clsName: "months", navFnc: n.hijri ? "iYear" : "y", navStep: 1 },
          { clsName: "years", navFnc: n.hijri ? "iYear" : "y", navStep: 10 },
          { clsName: "decades", navFnc: n.hijri ? "iYear" : "y", navStep: 100 },
        ],
        ...
        T = function (e) {
          ...
          return (
            void 0 !== t.tz &&
              ...
              (d = !0),
            null == e
              ? (a = d ? t().tz(n.timeZone).startOf("day") : t().startOf("day"))
              : d
              ? ((s = t().tz(n.timeZone).utcOffset()),
                t(e, _, n.useStrict).utcOffset() !== s
                  ? ((r = t().tz(n.timeZone).format("Z")),
                    (i =
                      t(e, _, n.useStrict).format("YYYY-MM-DD[T]HH:mm:ss") + r),
                    (a = t(i, _, n.useStrict).tz(n.timeZone)))
                  : (a = t(e, _, n.useStrict).tz(n.timeZone)))
              : (a = t(e, _, n.useStrict)),
            a
          );
        },
        ...
        H = function () {
          var t,
                  ...
                  e("<tr>")
                    .append(
                      e("<th>")
                        ...
                        .append(e("<span>").html(n.icons.previous))
                    )
                    .append(
                      e("<th>")
                    ...
                    .append(
                      e("<th>")
                        ...
                        .append(e("<span>").html(n.icons.next))
                    )
                )),
                (m = e("<tbody>").append(
                  e("<tr>").append(
              ...
              .append(
                ...
                (_ = [
                  ...
                  e("<div>")
                    ...
                    .append(
                      e("<table>").addClass("table-condensed").append([t, a, s])
                    )),
                ]),
                v("h") && _.push(r),
                v("m") && _.push(i),
            ...
            p = e("<li>")
              .addClass(
                "picker-switch" + (n.collapse ? " accordion-toggle" : "")
              )
              .append(
                (function () {
                  var t = [];
                      ...
                      t.push(
                        e("<td>").append(
                          e("<a>")
                            ...
                            .append(e("<span>").html(n.icons.today))
                        )
                      ),
                    !n.sideBySide &&
                      S() &&
                      ...
                      t.push(
                        e("<td>").append(
                          e("<a>")
                            ...
                            .append(e("<span>").html(n.icons.clear))
                        )
                      ),
                    n.showClose &&
                      t.push(
                        e("<td>").append(
                          e("<a>")
                            ...
                            .append(e("<span>").html(n.icons.close))
                        )
                      ),
                    n.showSwitcher)
                  ) {
                    let a = n.hijriText;
                    n.hijri && (a = n.gregorianText),
                      t.push(
                        e("<td>").append(
                          e("<a>")
                            .attr({
                            ...
                            .append(
                              e('<span class="data-switch-button">').html(a)
                            )
                        )
                      );
                  }
          ...
          return (
            n.inline && l.removeClass("dropdown-menu"),
            d && l.addClass("usetwentyfour"),
            v("s") && !d && l.addClass("wider"),
            n.sideBySide && S() && b()
              ? (l.addClass("timepicker-sbs"),
                "top" === n.toolbarPlacement && l.append(p),
                l.append(
                  e("<div>")
                    .addClass("row")
                ...
                "bottom" === n.toolbarPlacement && l.append(p),
                l)
              : ("top" === n.toolbarPlacement && M.append(p),
                S() &&
                  M.append(
                    e("<li>")
                      .addClass(n.collapse && b() ? "collapse in" : "")
                      .append(h)
                  ),
                "default" === n.toolbarPlacement && M.append(p),
                b() &&
                  M.append(
                    e("<li>")
                      .addClass(n.collapse && S() ? "collapse" : "")
                      .append(c)
                  ),
                "bottom" === n.toolbarPlacement && M.append(p),
                l.append(M))
          );
        },
        j = function () {
          ...
          if (
            ("auto" === i &&
              (i =
                ...
                p.height() + a.outerHeight() < r.top
                  ? "top"
                  : "bottom"),
            "auto" === d &&
              (d =
                t.width() < r.left + p.outerWidth() / 2 &&
                r.left + p.outerWidth() > e(window).width()
                  ? "right"
                  : "left"),
            "top" === i
              ? p.addClass("top").removeClass("bottom")
              : p.addClass("bottom").removeClass("top"),
            "right" === d
              ? p.addClass("pull-right")
              : p.removeClass("pull-right"),
          ...
          p.css({
            ...
            right:
              "left" === d
                ? "auto"
                : t.outerWidth() - a.outerWidth() - (t === a ? 0 : s.left),
          });
        },
        x = function (e) {
          ("dp.change" === e.type &&
        ...
        W = function (e) {
          "y" === e && (e = "YYYY"),
            "M" === e && (e = "YYYY MMMM"),
            x({ type: "dp.update", change: e, viewDate: r.clone() });
        },
        P = function (e) {
          p &&
            (e && (u = Math.max(f, Math.min(2, u + e))),
            p
              .find(".datepicker > div")
              .hide()
              .filter(".datepicker-" + Y[u].clsName)
              .show());
        },
        F = function (t, a) {
          ...
          if (
            n.disabledDates &&
            "d" === a &&
            ((s = t), !0 === n.disabledDates[s.format("YYYY-MM-DD")])
          )
            return !1;
          var s;
          if (
        ...
        C = function () {
          for (
            var t = [], a = r.clone().startOf("y").startOf("day");
            a.isSame(r, "years");
        ...
        E = function () {
          ...
          i.eq(0).find("span").attr("title", n.tooltips.prevYear),
            i.eq(1).attr("title", n.tooltips.selectYear),
            i.eq(2).find("span").attr("title", n.tooltips.nextYear),
            a.find(".disabled").removeClass("disabled"),
            i.eq(1).text(r.iYear()),
            A(r.clone().subtract(1, "iYear").format("iYYYY")) ||
              i.eq(0).addClass("disabled"),
            A(r.clone().add(1, "iYear").format("iYYYY")) ||
        ...
        z = function () {
          if (n.hijri) J();
            ...
            var t,
              ...
              i,
              d,
              o = p.find(".datepicker-days"),
              _ = o.find("th"),
              u = [];
            if (S()) {
              for (
                _.eq(0).find("span").attr("title", n.tooltips.prevMonth),
                  _.eq(1).attr("title", n.tooltips.selectMonth),
                  _.eq(2).find("span").attr("title", n.tooltips.nextMonth),
                  o.find(".disabled").removeClass("disabled"),
                  _.eq(1).text(r.format(n.dayViewHeaderFormat)),
                  F(r.clone().subtract(1, "months"), "months") ||
                    _.eq(0).addClass("disabled"),
                  F(r.clone().add(1, "months"), "months") ||
                    _.eq(2).addClass("disabled"),
                  t = r
                    .clone()
                    .startOf("months")
                    .startOf("weeks")
                ...
                0 === t.weekday() &&
                  ((a = e("<tr>")),
                  n.calendarWeeks &&
                    a.append('<td class="cw">' + t.week() + "</td>"),
                  u.push(a)),
                  (i = ""),
                  t.isBefore(r, "months") && (i += " old"),
                  t.isAfter(r, "months") && (i += " new"),
                  t.isSame(s, "days") && !c && (i += " active"),
                  F(t, "days") || (i += " disabled"),
                  t.isSame(T(), "days") && (i += " today"),
                  (6 !== t.day() && 5 !== t.day()) || (i += " weekend"),
                  a.append(
              ...
              o.find("tbody").empty().append(u),
                ...
                (function () {
                  var e = p.find(".datepicker-years"),
                    ...
                    d = "";
                  for (
                    t.eq(0).find("span").attr("title", n.tooltips.prevDecade),
                      ...
                      t.eq(1).text(a.year() + "-" + i.year()),
                      n.maxDate &&
                        n.maxDate.isBefore(i, "y") &&
        ...
        J = function () {
          var a,
            ...
            d,
            o,
            _ = p.find(".datepicker-days"),
            u = _.find("th"),
            m = [];
          if (S()) {
            for (
              u.eq(0).find("span").attr("title", n.tooltips.prevMonth),
                u.eq(1).attr("title", n.tooltips.selectMonth),
                u.eq(2).find("span").attr("title", n.tooltips.nextMonth),
                _.find(".disabled").removeClass("disabled"),
                u.eq(1).text(r.format(n.hijriDayViewHeaderFormat)),
                F(r.clone().subtract(1, "iMonth"), "iMonth") ||
                  u.eq(0).addClass("disabled"),
                F(r.clone().add(1, "iMonth"), "iMonth") ||
                  u.eq(2).addClass("disabled"),
                a = r.clone().startOf("iMonth").startOf("week"),
                o = 0;
              o < 42;
              o++
            )
              0 === a.weekday() &&
                ((i = e("<tr>")),
                n.calendarWeeks &&
                  i.append('<td class="cw">' + a.week() + "</td>"),
                m.push(i)),
                (d = ""),
                a.iMonth() < r.iMonth() && (d += " old"),
                a.iMonth() > r.iMonth() && (d += " new"),
                a.isSame(s, "d") && !c && (d += " active"),
                F(a, "d") || (d += " disabled"),
                a.isSame(t(), "d") && (d += " today"),
                (5 !== a.day() && 6 !== a.day()) || (d += " weekend"),
                i.append(
                  '<td data-action="selectDay" data-mday="' +
                    a.date() +
                    '" data-day="' +
                    a.format("L") +
                    '" class="day' +
            ...
            _.find("tbody").empty().append(m),
              ...
              (function () {
                let t = p.find(".datepicker-years"),
                  ...
                  o = e("<div></div>");
                if (
                  (a.eq(0).find("span").attr("title", n.tooltips.prevDecade),
                  a.eq(1).attr("title", n.tooltips.selectDecade),
                  a.eq(2).find("span").attr("title", n.tooltips.nextDecade),
                  a.eq(1).text(i.iYear() + "-" + d.iYear()),
                  t.find(".disabled").removeClass("disabled"),
                  n.minDate &&
                    n.minDate.isAfter(i, "iy") &&
                    a.eq(0).addClass("disabled"),
                  n.maxDate &&
                    n.maxDate.isBefore(d, "iy") &&
                    a.eq(2).addClass("disabled"),
                  1355 != i.iYear())
                ) {
                  for (; !i.isAfter(d, "y"); ) {
                    let t = e(
                        '<span data-action="selectYear" class="year"></span>'
                      ),
                      a = i.iYear() === s.iYear(),
                      n = !A(i.format("iYYYY"));
                    t.html(i.iYear()),
        ...
        I = function () {
          var t,
            a,
            i = p.find(".timepicker span[data-time-component]");
          d ||
            ((t = p.find(".timepicker [data-action=togglePeriod]")),
            (a = s.clone().add(s.hours() >= 12 ? -12 : 12, "h")),
            t.text(s.format("A")),
            F(a, "h") ? t.removeClass("disabled") : t.addClass("disabled")),
            i
              .filter("[data-time-component=hours]")
              .text(s.format(d ? "HH" : "hh")),
            i.filter("[data-time-component=minutes]").text(s.format("mm")),
            i.filter("[data-time-component=seconds]").text(s.format("ss")),
            (function () {
              var t = p.find(".timepicker-hours table"),
                ...
                s = e("<tr>");
              for (
                r.hour() > 11 && !d && a.hour(12);
                a.isSame(r, "d") &&
                (d || (r.hour() < 12 && a.hour() < 12) || r.hour() > 11);

              )
                a.hour() % 4 == 0 && ((s = e("<tr>")), n.push(s)),
                  s.append(
            ...
            (function () {
              for (
                var t = p.find(".timepicker-minutes table"),
                  a = r.clone().startOf("h"),
                  s = [],
                  i = e("<tr>"),
                  d = 1 === n.stepping ? 5 : n.stepping;
                r.isSame(a, "h");

              )
                a.minute() % (4 * d) == 0 && ((i = e("<tr>")), s.push(i)),
                  i.append(
            ...
            (function () {
              for (
                var t = p.find(".timepicker-seconds table"),
                  a = r.clone().startOf("m"),
                  n = [],
                  s = e("<tr>");
                r.isSame(a, "m");
        ...
        G = function (e) {
          ...
          if (!e)
            return (
              ...
              i.val(""),
              a.data("date", ""),
              x({ type: "dp.change", date: !1, oldDate: t }),
              void N()
            );
          (e = e.clone().locale(n.locale)),
            1 !== n.stepping &&
              e
                .minutes(
                  (Math.round(e.minutes() / n.stepping) * n.stepping) % 60
                )
                .seconds(0),
            F(e)
              ? ((r = (s = e).clone()),
                i.val(s.format(o)),
                a.data("date", s.format(o)),
                (c = !1),
                N(),
                x({ type: "dp.change", date: s.clone(), oldDate: t }))
              : (n.keepInvalid || i.val(c ? "" : s.format(o)),
                x({ type: "dp.error", date: e }));
        },
        V = function () {
          var t = !1;
          return p
            ? (p.find(".collapse").each(function () {
              ...
              t
                ...
                : (M && M.hasClass("btn") && M.toggleClass("active"),
                  p.hide(),
                  e(window).off("resize", j),
                  p.off("click", "[data-action]"),
                  p.off("mousedown", !1),
                  p.remove(),
                  (p = !1),
                  x({ type: "dp.hide", date: s.clone() }),
                  i.blur(),
                  h))
            : h;
        },
        ...
        q = {
          ...
          selectMonth: function (t) {
            var a = e(t.target)
              ...
              .find("span")
              .index(e(t.target));
            n.hijri ? r.iMonth(a) : r.month(a),
              u === f
                ? (n.hijri
                    ? G(s.clone().year(r.iYear()).month(r.iMonth()))
                    : G(s.clone().year(r.year()).month(r.month())),
                  n.inline || V())
                : (P(-1), z()),
              n.hijri ? W("iM") : W("M");
          },
          selectYear: function (t) {
            ...
            n.hijri ? r.iYear(a) : r.year(a),
              u === f
                ? (n.hijri
                    ? G(s.clone().iYear(r.iYear()))
                    : G(s.clone().year(r.year())),
                  n.inline || V())
                : (P(-1), z()),
              n.hijri ? W("hYYYY") : W("YYYY");
          },
          ...
          selectDay: function (t) {
            var a = r.clone();
            n.hijri
              ? (e(t.target).is(".old") && a.subtract(1, "iMonth"),
                e(t.target).is(".new") && a.add(1, "iMonth"),
                G(a.iDate(parseInt(e(t.target).text(), 10))))
              : (e(t.target).is(".old") && a.subtract(1, "months"),
                e(t.target).is(".new") && a.add(1, "months"),
                G(a.date(parseInt(e(t.target).text(), 10)))),
              b() || n.keepOpen || n.inline || V();
          },
          ...
          togglePicker: function (t) {
            ...
            if (i && i.length) {
              ...
              i.collapse
                ? (i.collapse("hide"), d.collapse("show"))
                : (i.removeClass("in"), d.addClass("in")),
                s.is("span")
                  ? s.toggleClass(n.icons.time + " " + n.icons.date)
                  : s
                      .find("span")
                      .toggleClass(n.icons.time + " " + n.icons.date);
            }
          },
          showPicker: function () {
            p.find(".timepicker > div:not(.timepicker-picker)").hide(),
              p.find(".timepicker .timepicker-picker").show();
          },
          showHours: function () {
            p.find(".timepicker .timepicker-picker").hide(),
              p.find(".timepicker .timepicker-hours").show();
          },
          showMinutes: function () {
            p.find(".timepicker .timepicker-picker").hide(),
              p.find(".timepicker .timepicker-minutes").show();
          },
          showSeconds: function () {
            p.find(".timepicker .timepicker-picker").hide(),
              p.find(".timepicker .timepicker-seconds").show();
          },
          selectHour: function (t) {
            var a = parseInt(e(t.target).text(), 10);
            d ||
              (s.hours() >= 12 ? 12 !== a && (a += 12) : 12 === a && (a = 0)),
              G(s.clone().hours(a)),
              q.showPicker.call(h);
          },
          selectMinute: function (t) {
            G(s.clone().minutes(parseInt(e(t.target).text(), 10))),
              q.showPicker.call(h);
          },
          selectSecond: function (t) {
            G(s.clone().seconds(parseInt(e(t.target).text(), 10))),
              q.showPicker.call(h);
          },
          clear: U,
          today: function () {
          ...
          switchDate: function () {
            n.hijri
              ? ((n.hijri = !1),
                ...
                C(),
                ae(),
                e(".data-switch-button").html(n.hijriText))
              : ((n.hijri = !0),
                J(),
                O(),
                ae(),
                e(".data-switch-button").html(n.gregorianText));
          },
        },
        R = function (t) {
          return (
            !e(t.currentTarget).is(".disabled") &&
            (q[e(t.currentTarget).data("action")].apply(h, arguments), !1)
          );
        },
        Z = function () {
          var t;
          return i.prop("disabled") ||
            (!n.ignoreReadonly && i.prop("readonly")) ||
            p
            ? h
            : (void 0 !== i.val() && 0 !== i.val().trim().length
                ...
                : n.useCurrent &&
                  c &&
                  ((i.is("input") && 0 === i.val().trim().length) ||
                    n.inline) &&
                  ((t = T()),
              ...
              n.hijri ? O() : C(),
              p.find(".timepicker-hours").hide(),
              p.find(".timepicker-minutes").hide(),
              p.find(".timepicker-seconds").hide(),
              N(),
              P(),
              e(window).on("resize", j),
              p.on("click", "[data-action]", R),
              p.on("mousedown", !1),
              M && M.hasClass("btn") && M.toggleClass("active"),
              p.show(),
              j(),
              n.focusOnShow && !i.is(":focus") && i.focus(),
              x({ type: "dp.show" }),
              h);
        },
        B = function () {
        ...
        K = function (e) {
          ...
          for (t in ((w[_] = "p"), w))
            w.hasOwnProperty(t) &&
              "p" === w[t] &&
              (d.push(t), parseInt(t, 10) !== _ && (o[t] = !0));
          for (t in n.keyBinds)
            if (
              n.keyBinds.hasOwnProperty(t) &&
              "function" == typeof n.keyBinds[t] &&
              (s = t.split(" ")).length === d.length &&
              g[_] === s[s.length - 1]
            ) {
        ...
        ae = function () {
          var e = n.format || "L LT";
          n.hijri && (e = n.hijriFormat),
            (o = e.replace(
              /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,
              function (e) {
                return (s.localeData().longDateFormat(e) || e).replace(
                  /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,
                  function (e) {
            ...
            (_ = n.extraFormats ? n.extraFormats.slice() : []).indexOf(e) < 0 &&
              _.indexOf(o) < 0 &&
              _.push(o),
            (d =
      ...
      if (
        ((h.destroy = function () {
          V(),
            ...
            a.is("input")
              ? i.off({ focus: Z })
              : M && (M.off("click", B), M.off("mousedown", !1)),
        ...
        (h.hijriDayViewHeaderFormat = function (e) {}),
        ...
        (h.enabledDates = function (t) {
          if (0 === arguments.length)
            return n.enabledDates
              ? e.extend({}, n.enabledDates)
              : n.enabledDates;
        ...
        (h.daysOfWeekDisabled = function (e) {
          ...
          if ("boolean" == typeof e && !e)
            return (n.daysOfWeekDisabled = !1), N(), h;
        ...
        (h.maxDate = function (e) {
          ...
          return (
            (n.maxDate = t),
            n.useCurrent && !n.keepInvalid && s.isAfter(e) && G(n.maxDate),
            r.isAfter(t) && (r = t.clone().subtract(n.stepping, "m")),
            N(),
            h
          );
        }),
        (h.minDate = function (e) {
          ...
          return (
            (n.minDate = t),
            n.useCurrent && !n.keepInvalid && s.isBefore(e) && G(n.minDate),
            r.isBefore(t) && (r = t.clone().add(n.stepping, "m")),
            N(),
            h
          );
        }),
        (h.defaultDate = function (e) {
          ...
          return (
            (n.defaultDate = t),
            ((n.defaultDate && n.inline) || "" === i.val().trim()) &&
              G(n.defaultDate),
            h
          );
        }),
        (h.hijri = function (e) {
          if (0 === arguments.length)
            return (
              n.hijri && (n.viewModes = ["days", "months", "years"]), n.hijri
            );
          if ("boolean" != typeof e)
            throw new TypeError("hijri() expects a boolean parameter");
          return (
            (n.hijri = e),
            n.hijri && (n.viewModes = ["days", "months", "years"]),
            h
          );
        }),
        (h.isRTL = function () {
        ...
        (h.viewMode = function (e) {
          ...
          if (-1 === L.indexOf(e))
            throw new TypeError(
              "viewMode() parameter must be one of (" + L.join(", ") + ") value"
            );
        ...
        (h.enabledHours = function (t) {
          if (0 === arguments.length)
            return n.enabledHours
              ? e.extend({}, n.enabledHours)
              : n.enabledHours;
        ...
        i = a;
      else if (0 === (i = a.find(n.datepickerInput)).size())
        i = a.find("input");
      else if (!i.is("input"))
        throw new Error(
          'CSS class "' +
      ...
      return (
        ...
        e.extend(
          ...
          n,
          ((l = {}),
          (m = a.is("input") || n.inline ? a.data() : a.find("input").data())
            .dateOptions &&
            m.dateOptions instanceof Object &&
            (l = e.extend(!0, l, m.dateOptions)),
          e.each(n, function (e) {
        ...
        a.is("input")
          ? i.on({ focus: Z })
          : M && (M.on("click", B), M.on("mousedown", !1)),
        i.prop("disabled") && h.disable(),
        i.is("input") && 0 !== i.val().trim().length
          ? G($(i.val().trim()))
          : n.defaultDate &&
    ...
    (e.fn.hijriDatePicker = function (t) {
      return this.each(function () {
        var n = e(this);
        n.data("HijriDatePicker") ||
          ((t = e.extend(!0, {}, e.fn.hijriDatePicker.defaults, t)),
          n.data("HijriDatePicker", a(n, t)));
      });
    }),
        ...
        keyBinds: {
          ...
          "control up": function (e) {
            if (e) {
              var t = this.date() || this.getMoment();
              e.find(".datepicker").is(":visible")
                ? this.date(t.clone().subtract(1, "years"))
          ...
          left: function (e) {
            if (e) {
              var t = this.date() || this.getMoment();
              e.find(".datepicker").is(":visible") &&
                this.date(t.clone().subtract(1, "days"));
            }
          },
          right: function (e) {
            if (e) {
          ...
          pageUp: function (e) {
            if (e) {
              var t = this.date() || this.getMoment();
              e.find(".datepicker").is(":visible") &&
                this.date(t.clone().subtract(1, "months"));
            }
          },
          pageDown: function (e) {
            if (e) {
              var t = this.date() || this.getMoment();
              e.find(".datepicker").is(":visible") &&
                this.date(t.clone().add(1, "months"));
            }
          },
          enter: function () {
            this.hide();

(function (global, factory) {
  ...
  var bn = moment__default.defineLocale("bn", {
    ...
    weekdays:
      "রবিবার_সোমবার_মঙ্গলবার_বুধবার_বৃহস্পত্তিবার_শুক্রবার_শনিবার".split("_"),
  ...
  var cs__months =
    ...
    cs__monthsShort = "led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split(
      "_"
    );
  ...
  var monthsShortDot =
    ...
    es__monthsShort = "ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic".split(
      "_"
    );
  ...
  var fy__monthsShortWithDots =
      "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split("_"),
    fy__monthsShortWithoutDots =
  ...
  var kk = moment__default.defineLocale("kk", {
    ...
    ordinal: function (number) {
      ...
      return (
        number + (kk__suffixes[number] || kk__suffixes[a] || kk__suffixes[b])
      );
    },
    week: {
      dow: 1, // Monday is the first day of the week.
  ...
  var me__translator = {
    ...
    translate: function (number, withoutSuffix, key) {
      ...
      if (key.length === 1) {
        ...
        return (
          number + " " + me__translator.correctGrammaticalCase(number, wordKey)
        );
      }
    },
  };
  ...
  var nl__monthsShortWithDots =
      "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_"),
    nl__monthsShortWithoutDots =
  ...
  var sk__months =
    ...
    sk__monthsShort = "jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec".split(
      "_"
    );
    ...
    translate: function (number, withoutSuffix, key) {
      ...
      if (key.length === 1) {
        ...
        return (
          number +
          " " +
          sr_cyrl__translator.correctGrammaticalCase(number, wordKey)
        );
      }
    },
  };
  ...
  var sr__translator = {
    ...
    translate: function (number, withoutSuffix, key) {
      ...
      if (key.length === 1) {
        ...
        return (
          number + " " + sr__translator.correctGrammaticalCase(number, wordKey)
        );
      }
    },
  };
  ...
  var hijriDatePicker = function (element, options) {
    var picker = {},
        ...
        if (d === undefined || d === null) {
          ...
          if (tzEnabled) {
            ...
            if (incomingZoneOffset !== currentZoneOffset) {
              ...
              dateWithTimeZoneInfo =
                moment(d, parseFormats, options.useStrict).format(
              ...
              returnMoment = moment(d, parseFormats, options.useStrict).tz(
                options.timeZone
              );
            }
          } else {
      ...
      showMode = function (dir) {
        ...
        if (dir) {
          currentViewMode = Math.max(
            minViewModeNumber,
            Math.min(2, currentViewMode + dir)
          );
        }
        widget
          .find(".datepicker > div")
      ...
      updateHijriMonths = function () {
        ...
        if (
          !isValidHijriYear(
            viewDate.clone().subtract(1, "iYear").format("iYYYY")
          )
        ) {
          monthsViewHeader.eq(0).addClass("disabled");
        }
        if (
          !isValidHijriYear(viewDate.clone().add(1, "iYear").format("iYYYY"))
        ) {
        ...
        months.each(function (index) {
          ...
          if (
            date.isSame(viewDate, "iM") &&
            selectedMonth &&
            $(this).attr("data-month") == selectedMonth
          ) {
      ...
      fillHijriDate = function () {
        ...
        daysViewHeader
          .eq(1)
          .text(viewDate.format(options.hijriDayViewHeaderFormat));
      ...
      actions = {
        ...
        selectMonth: function (e) {
          ...
          if (currentViewMode === minViewModeNumber) {
            if (options.hijri) {
              setValue(
                date.clone().year(viewDate.iYear()).month(viewDate.iMonth())
              );
            } else {
              setValue(

    ...
    <div class="row-state">
        <div class="form-group-state">
            ...
            <select id="electricity-meter-ownership" class="select-state" name="electricity_meter_ownership">
                ...
                <option value="owner" @if(old('electricity_meter_ownership', $unit->electricity_meter_ownership) === 'owner') selected @endif>مالك</option>
                <option value="tenant" @if(old('electricity_meter_ownership', $unit->electricity_meter_ownership) === 'tenant') selected @endif>مستأجر</option>
            </select>
        </div>
        <div class="form-group-state">
            ...
            <select id="water-meter-ownership" class="select-state" name="water_meter_ownership">
                ...
                <option value="owner" @if(old('water_meter_ownership', $unit->water_meter_ownership) === 'owner') selected @endif>مالك</option>
                <option value="tenant" @if(old('water_meter_ownership', $unit->water_meter_ownership) === 'tenant') selected @endif>مستأجر</option>
            </select>
        </div>
    </div>

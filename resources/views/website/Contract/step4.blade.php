...
<form action="{{ route('submit.step4', $contract->uuid) }}" method="POST" class="form-content-state" id="rent-form"
...
@enderror
    ...
    @enderror
        <div class="buttons-state">
            <a href="{{ route('contract.step3', $contract->uuid) }}" class="back-button-state">عودة</a>
 ...
 <script>
     $(document).ready(function() {
             ...
             $.ajax({
                 ...
                 success: function(response) {
                     ...
                     if (cities && cities.length > 0) {
                         ...
                         cityDropdown.append('<option value="none" disabled selected>لا توجد مدن متاحة</option>');
                     }
                 },
         ...
         // Trigger city update if region is already selected on page load
